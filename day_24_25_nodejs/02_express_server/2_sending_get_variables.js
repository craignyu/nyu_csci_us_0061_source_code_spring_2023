...
app.get('/', function(request, result) {
  ...
  // append a random number as a GET variable to our hyperlink
  result.write(`<a href="/about?num=${Math.random()}">About our site</a>`);

  // include an image in our response to the client
  result.write(`<img src="pikachu.png">`);
...
app.get('/about', function(request, result) {
  ...
  // extract the 'num' GET variable
  let num = request.query.num;
  result.write(`<p>The GET variable I received was: ${num}</p>`);
  ...
  // include an image in our response to the client
  result.write(`<img src="squirtle.png">`);
